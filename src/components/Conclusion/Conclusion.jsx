...
export const Conclusion = () => {
    ...
    return (
        ...
        >
            ...
            <div
                className="container mx-auto relative z-10 w-full px-4 py-12 md:py-16 flex flex-col md:flex-row justify-evenly items-center gap-12s">
                {/* Left Side */}
                <div className="md:w-1/2 space-y-6 text-left">
                    ...
                    <a href="tel:+375333600854">
                        <div
                            className="flex items-center bg-[#ffc752] text-black overflow-hidden shadow-lg w-full sm:w-[420px] hover:opacity-90 transition rounded-md">
                            <img
                                src="/Member.jpg"
                                alt="Expert"
